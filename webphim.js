...
function handleSearch() {
  ...
  // Danh sách từ khóa và file tương ứng
  const searchRoutes = {
    "việt nam": "quocgia vietnam.html",
    "hàn quốc": "quocgia hanquoc.html",
    "mỹ": "quocgia my.html",
    // Bạn có thể thêm nhiều mục ở đây
  };

  if (searchRoutes[input]) {
    window.location.href = searchRoutes[input];
  } else {
    alert("Không tìm thấy phim hoặc quốc gia phù hợp!");
  }
}
